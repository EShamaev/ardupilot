...
public:
    /*  CAN port open method
     ...
     Opens port with specified bit rate and type.
     CAN 2.0B is back compatible with CAN 2.0A and such devices can be opened with both types

     bitrate     Selects the speed that the port will be configured to.  If zero, the port speed is left
     unchanged.

     return      0 - CAN port open failed
     code of error can be read with get_last_error() method
     1 - CAN port open succeeded
     */
    ...
    /*
     ...
     return      0 - CAN port close failed
     code of error can be read with get_last_error() method
     1 - CAN port close succeeded
     */
    virtual void end() = 0;
    ...
    /*
     ...
     return      0 - CAN port not initialized
     code of error can be read with get_last_error() method
     1 - CAN port is initialized
     */
...
public:
    ...
    /*
     ...
     return      0 - CAN manager not initialized
     code of error can be read with get_last_error() method
     1 - CAN manager is initialized
     */
    virtual bool is_initialized() = 0;
