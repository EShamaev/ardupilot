    ...
    AP_Compass_Backend(compass)
{
    if (hal.can_mgr != nullptr) {
        ...
        if (ap_uavcan != nullptr) {
            ...
            ap_uavcan->register_mag_listener(this, 1);
...
// detect the sensor
AP_Compass_Backend *AP_Compass_UAVCAN::detect(Compass &compass)
{
    AP_Compass_UAVCAN *sensor = new AP_Compass_UAVCAN(compass);
    if (sensor == nullptr) {
        return nullptr;
    }
